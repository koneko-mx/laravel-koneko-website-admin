...
<div class="row">
    <div class="col-xl-6 col-lg-12">
        @livewire('koneko-website-admin::site.template-card', ['seoableType' => 'site', 'seoableId' => $site->id])
    </div>
    <div class="col-xl-6 col-lg-12">
        @livewire('koneko-website-admin::site.favicon-card', ['seoableType' => 'site', 'seoableId' => $site->id])
    </div>
</div>
