...
namespace Koneko\KonekoWebsiteAdmin\Services;
 ...
 *
 * @package Koneko\KonekoWebsiteAdmin\Services
 */
class ___WebsiteSettingsService
{
    ...
    public function processAndSaveFavicon($image): void
    {
        ...
        $SettingsService->set('website.favicon_ns', $this->favicon_basePath . $imageName, null, 'koneko-website-admin');
    }
    ...
    private function generateAndSaveImage($image, string $type, int $maxPixels, string $suffix = ''): void
    {
        ...
        $SettingsService = app(SettingsService::class);
        $SettingsService->set($keyValue, $resizedPath, null, 'koneko-website-admin');
    }
    ...
    private function generateAndSaveImageAsBase64($image, string $type, int $maxPixels): void
    {
        ...
        $SettingsService = app(SettingsService::class);
        $SettingsService->set("website.image.logo_base64" . ($type === 'dark' ? '_dark' : ''), $base64Image, null, 'koneko-website-admin');
    }
